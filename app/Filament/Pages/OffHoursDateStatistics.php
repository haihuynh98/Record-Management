...
class OffHoursDateStatistics extends Page implements HasTable
{
    use InteractsWithTable;
    use HasPageShield;

    protected static ?string $navigationIcon = 'heroicon-o-calendar-days';
    protected static ?string $navigationLabel = 'Thống kê ngoài giờ theo ngày';
    protected static ?string $title = 'Thống kê ngoài giờ theo ngày';
    protected static ?string $slug = 'off-hours-date-statistics';
    protected static ?string $navigationGroup = 'Thống kê ngoài giờ';
    protected static ?int $navigationSort = 2;

    protected static string $view = 'filament.pages.off-hours-date-statistics';
    ...
    {
        return 'off_hours_date_statistics';
    }
    ...
    protected function getTableQuery(): Builder
    {
        ...
        return User::query()
            ...
            ->withCount([
                'profiles as profile_count' => function ($query) use ($startDate, $endDate, $startTime, $endTime) {
