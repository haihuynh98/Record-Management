...
class ProfileApprovedByDateStatistics extends Page implements HasTable
{
    use InteractsWithTable;
    use HasPageShield;

    protected static ?string $navigationIcon = 'heroicon-o-calendar-days';
    protected static ?string $navigationLabel = 'Thống kê người duyệt theo ngày';
    protected static ?string $title = 'Thống kê người duyệt theo ngày';
    protected static ?string $slug = 'profile-approved-by-date-statistics';
    protected static ?string $navigationGroup = 'Báo cáo';
    protected static ?int $navigationSort = 5;

    protected static string $view = 'filament.pages.profile-approved-by-date-statistics';
    ...
    {
        return 'profile_approved_by_date_statistics';
    }
