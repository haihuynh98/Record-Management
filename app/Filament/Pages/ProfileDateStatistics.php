...
class ProfileDateStatistics extends Page implements HasTable
{
    use InteractsWithTable;
    use HasPageShield;

    protected static ?string $navigationIcon = 'heroicon-o-calendar';
    protected static ?string $navigationLabel = 'Thống kê theo ngày';
    protected static ?string $title = 'Thống kê theo ngày';
    protected static ?string $slug = 'profile-date-statistics';
    protected static ?string $navigationGroup = 'Báo cáo';
    protected static ?int $navigationSort = 3;

    protected static string $view = 'filament.pages.profile-date-statistics';
    ...
    {
        return 'profile_date_statistics';
    }
